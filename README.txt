...
Donate link: http://cherifbouchelaghem.com/
Tags: comments, spam
...
3. Select `event.zip` from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard

= Using FTP =

1. Download `event.zip`
2. Extract the `event` directory to your computer
3. Upload the `event` directory to the `/wp-content/plugins/` directory
